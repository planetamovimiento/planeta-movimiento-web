...
export const CATALOGO_SERVICIOS: ServicioCatalogo[] = [
  // ── CLUB DEPORTIVO ORIGEN (siempre formulario, nunca compra) ──────────────
  {
    ...
    preciosClub: [
      ...
      { concepto: '1 hora/semana · pago trimestral (3 meses)', precio: '120 €/trimestre' },
      { concepto: '2 horas/semana · pago trimestral (3 meses)', precio: '195 €/trimestre' },
      { concepto: '3 horas/semana · pago trimestral (3 meses)', precio: '285 €/trimestre' },
    ],

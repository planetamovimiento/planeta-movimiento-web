...
export const CUOTAS_MENSUALES: CuotaMensualActividad[] = [
  ...
  { actividad: 'Escuela infantil', opciones: [{ label: '1 día', cents: 4000, trimestralCents: 10500 }, { label: '2 días', cents: 6500, trimestralCents: 17500 }, { label: '3 días', cents: 9000 }] },

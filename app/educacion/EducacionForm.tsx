  ...
  return (
    <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); setSent(true) }}>
      ...
      <div>
        ...
        <input type="tel" required placeholder="657 606 465" className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-pm-red" />
      </div>
      <div>

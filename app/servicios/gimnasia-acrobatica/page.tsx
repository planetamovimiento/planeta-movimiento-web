...
export default function GimnasiaAcrobaticaPage() {
  const principal = fotoPrincipal('gimnasia-acrobatica')
  const miniaturas = fotosDe('gimnasia-acrobatica').slice(1, 4)
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-3">
            ...
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3] bg-pm-navy">
              {principal ? (
                /* eslint-disable-next-line @next/next/no-img-element */
                <img src={principal} alt="Clase de gimnasia acrobática" className="absolute inset-0 w-full h-full object-cover" />
              ) : (
              ...
              <div className="grid grid-cols-3 gap-3">
                {miniaturas.map((src, i) => (
                  <div key={src} className="rounded-xl overflow-hidden aspect-square bg-pm-bg">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={src} alt={`Gimnasia acrobática ${i + 2}`} loading="lazy" className="w-full h-full object-cover" />
                  </div>
                ))}
              </div>
            )}

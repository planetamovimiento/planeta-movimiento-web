        ...
        {tab === 'descripcion' ? (
          <div className="max-w-2xl space-y-4 text-gray-700 text-sm leading-relaxed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={d.nombre} className="bg-purple-50 border border-purple-100 rounded-xl p-4">
                    ...
                    <div className="font-bold text-pm-navy text-sm">{d.nombre}</div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <h3 className="text-pm-navy font-black text-base mb-3">¿Qué desarrollarás?</h3>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  'Fuerza de agarre y brazos', 'Flexibilidad progresiva',
                  'Control corporal', 'Pequeñas coreografías',
                  'Confianza en altura', 'Expresión artística',
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {[
                { label: 'Edad mínima', valor: '7 años' },
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Ropa ajustada (mallas o licra), sin cremalleras ni botones que puedan enganchar la tela.
                Todo el material aéreo lo ponemos nosotros.
              </p>
            </div>
            <div>
              <h3 className="font-black text-pm-navy text-base mb-1">Política de inscripción</h3>
              <p className="text-sm text-gray-600">
                La inscripción se formaliza una vez confirmada la plaza por nuestro equipo. El pago de la
                mensualidad se realiza los primeros 5 días de cada mes.
              </p>
            </div>
            <div>
              <h3 className="font-black text-pm-navy text-base mb-1">Modalidades disponibles</h3>
              <div className="grid grid-cols-2 gap-3">
                {[
                  { label: 'Clase suelta', desc: 'Ven un día sin compromiso' },
                  { label: '1 clase / semana', desc: 'Un día fijo a la semana' },
                  { label: '2 clases / semana', desc: 'Dos días fijos a la semana' },
                  { label: '3 clases / semana', desc: 'Máximo aprovechamiento' },
                ].map(m => (
                  <div key={m.label} className="border border-gray-200 rounded-xl p-3">
                    <div className="font-bold text-pm-navy text-sm">{m.label}</div>

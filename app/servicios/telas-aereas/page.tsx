...
export const metadata = {
  title: 'Escuela de aéreos — Telas, Aro y Trapecio | Planeta Movimiento',
  description:
    'Descubre la magia de volar con nuestras clases de telas aéreas, aro aéreo y trapecio fijo. Aprenderás figuras, subidas y pequeñas coreografías adaptadas a cada nivel.',
}
            ...
            <div className="relative bg-purple-900 rounded-2xl overflow-hidden aspect-[4/3] flex items-center justify-center">
              ...
              <div className="relative text-center px-6 space-y-2">
                ...
                <div className="space-y-0.5 mt-2">
                  {['Telas Aéreas', 'Aro Aéreo', 'Trapecio Fijo'].map(d => (
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              {[
                ...
                { icon: '📅', texto: 'Lun – Vie' },
                { icon: '🎗️', texto: 'Telas · Aro · Trapecio' },

...
import { ReservaDiasSinCole, ReservaDomingos, ReservaHalloween } from './EventosInstalaciones'
...
type TabCentro    = 'diassinc' | 'domingos' | 'halloween'
          ...
          <div className="flex">
            ...
            <button onClick={() => setTabPrincipal('centro')}
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="text-xs font-normal opacity-60 hidden sm:block">Días Sin Cole · Domingos · Halloween</div>
              </div>
            </button>
          </div>
        </div>

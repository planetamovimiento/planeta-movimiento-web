    ...
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10" id="reservar">
      ...
      <div className="lg:sticky lg:top-24 lg:self-start">
        ...
        <div className="mt-5 bg-white rounded-2xl border border-gray-100 shadow-sm p-5 space-y-3">
          ...
          <a href="https://wa.me/34657604665" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-green-600 hover:text-green-700 transition-colors font-semibold">

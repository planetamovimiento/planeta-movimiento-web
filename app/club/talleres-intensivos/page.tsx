      ...
      <section className="bg-pm-bg py-14" id="talleres">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 bg-white border border-gray-200 rounded-2xl p-5 text-center shadow-sm">
            ...
            <a href={waNegocio('Hola 👋, me gustaría recibir información sobre los Talleres Intensivos del Club Deportivo Origen.')} target="_blank" rel="noopener noreferrer"
